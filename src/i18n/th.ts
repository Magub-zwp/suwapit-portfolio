...
export const th: Dictionary = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      "ปัจจุบันผมศึกษาอยู่ชั้นปีที่4(คาดว่าจะจบในเดือน ก.พ. 2570) และผมพร้อมเติบโตในฐานะ junior developer ที่ช่วยเสริมความแข็งแกร่งให้กับทีม",
    ],
    facts: [
      { label: "ตำแหน่งปัจจุบัน", value: "IT Officer, โรงพยาบาลส่งเสริมสุขภาพตำบลบ้านต้นเปา" },
      {
        label: "การศึกษา",
        value: "2565-ปัจจุบัน\nวท.บ. วิทยาการคอมพิวเตอร์\nมหาวิทยาลัยราชภัฏเชียงใหม่\nGPA 3.22 | ภาคพิเศษ (เสาร์-อาทิตย์)\n (คาดว่าจะจบในเดือน ก.พ. 2570)",
      },
  ...
  certificates: {
    label: "ประกาศนียบัตร",
    heading: "อบรม แล้วลงมือสร้างจริง",
    view: "ดูใบประกาศ",
    items: [
      {
        id: "scitech-conference",
        title: "นำเสนอผลงานวิจัย Oral Presentation (GaragePlus) — งานประชุมวิชาการวิทยาศาสตร์และเทคโนโลยีระดับชาติ ครั้งที่ 4",
        issuer: "คณะวิทยาศาสตร์และเทคโนโลยี มรภ.เชียงใหม่",
        year: "2569",
      ...
      },
      {
        ...
        issuer: "ภาควิชาคอมพิวเตอร์ มรภ.เชียงใหม่",
        year: "2569",
        images: ["/images/certificates/digital-skills-2026.png"],
      },
      {
        id: "digital-literacy",
        title: "หลักสูตรเตรียมความพร้อมและทวนความรู้สมรรถนะดิจิทัล (CMRU MOOCs)",
        issuer: "สำนักดิจิทัลเพื่อการศึกษา มรภ.เชียงใหม่",
        year: "2569",
