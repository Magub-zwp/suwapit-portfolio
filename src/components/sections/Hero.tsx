  ...
  return (
    <section id="hero" className="min-h-screen flex flex-col justify-center">
      <div className="max-w-5xl mx-auto px-6 w-full py-24">
        ...
        {/* Name */}
        <h1
          className="font-serif text-dark leading-none mb-8"
        ...
        {/* Description */}
        <p className="font-sans text-muted text-lg max-w-md leading-relaxed mb-12">
          From hospital IT support to a 4th-year Computer Science student — turning real-world experience into working web applications.
        </p>
      ...
      <div className="flex justify-center pb-10">
        <div className="flex flex-col items-center gap-2 text-subtle">
          ...
          <div className="w-px h-10 bg-border" style={{ animation: "fade-up 1.5s ease-in-out infinite alternate" }} />
        </div>
      </div>
    </section>
  );
